...
import { LineChartProps } from '@/types/visualization.types';
import { formatAxisValue, getChartColors, getTheme } from '@/utils/chartHelpers';
import { useTheme } from '@/contexts/ThemeContext';

interface LineChartComponentProps extends LineChartProps {}
        ...
        <ResponsiveContainer width={width || '100%'} height={height}>
          ...
          >
            ...
            {seriesFields.map((field, index) => {
              ...
              const lineColor = seriesConfig?.color || colors[index % colors.length];
              ...
              return (
                <Line
                  ...
                  dot={dot ? { fill: lineColor, strokeWidth: 2, r: 4 } : false}
                  activeDot={activeDot ? { r: 6, fill: lineColor } : false}
